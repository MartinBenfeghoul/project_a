...
def extract_results_from_line(line, dict_obj, prev_task_name=None):
    ...
    _, task_name, version, filter_name, n_shot, metric, _, value, _, std, _ = parts
