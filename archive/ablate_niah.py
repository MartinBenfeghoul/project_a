...
def main(
    ...
    **kwargs,
    ...
    success_matrix = np.zeros((len(datasets), len(values)), dtype=np.float32)
...
def add_to_parser(parser):
    parser.add_argument("--data_dir", type=str, default="data/NIAH/multi-keys")
    parser.add_argument(
        "-s",
        "--seq_lens",
...
if __name__ == "__main__":
    parser = add_to_parser(get_parser())
